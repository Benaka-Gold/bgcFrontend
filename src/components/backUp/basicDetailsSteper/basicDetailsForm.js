...
function ApplicationForm() {
  ...
  const validateTotalNumberOfOrnaments = (number) => {
    return /^\d+$/.test(number) || "Total number of ornaments must be a number";
  };
  return (
      ...
      <StyledFormBox noValidate>
        <Box sx={{
          ...
          <Grid container spacing={2}>
            ...
            <CustomTextField name={'email'} label={'E-mail'} isRequired={true} validation={validateEmail}/>
            <CustomTextField name={'totalNumberOfOrnaments'} label={'Total Number Of Ornaments'} isRequired={true} validation={validateTotalNumberOfOrnaments} type={'number'}/>
            <CustomSelect
